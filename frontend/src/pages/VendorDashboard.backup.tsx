          ...
          <div className="bg-white rounded-xl shadow-sm border border-neutral-200 p-6">
            ...
            <form className="space-y-4" onSubmit={handleSubmit}>
              ...
              <div>
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-xs text-gray-500">
                    📸 Upload a product image (JPEG, PNG, WebP, or GIF - Max
                    5MB)
                  </p>
              ...
              <button
                ...
                className="w-full py-3 bg-primary-600 text-white rounded-lg hover:bg-primary-700 transition font-semibold disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center shadow-sm"
              >
                {loading ? (
                  <>
                    <svg
