    ...
    return (
      <div className="flex items-center justify-center min-h-[60vh]">
        <div className="text-center">
          <div className="animate-spin rounded-full h-16 w-16 border-b-2 border-[#8C5630] mx-auto"></div>
  ...
  return (
    <div className="max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div className="bg-gradient-to-br from-[#B97D45] to-[#A66B3A] text-white rounded-xl p-6 shadow-lg">
          <div className="flex items-center justify-between mb-2">
          ...
          <div className="space-y-4">
            {trending.length === 0 ? (
              ...
              trending.slice(0, 5).map((product, index) => (
                ...
                >
                  <div className="flex-shrink-0 w-10 h-10 bg-gradient-to-br from-[#8C5630] to-[#754626] text-white rounded-full flex items-center justify-center font-bold">
                    #{index + 1}
                  </div>
            ...
            analytics.recentProducts.length === 0 ? (
              ...
              analytics.recentProducts.map((product) => (
                ...
                >
                  ...
                  <span className="text-xs bg-[#F5E6D3] text-[#8C5630] px-3 py-1 rounded-full font-medium">
                    New
                  </span>
                </div>
              ))
